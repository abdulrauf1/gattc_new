...
<div class="mx-auto max-w-4xl space-y-6">
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div>
            ...
            <p class="mt-1 text-sm text-slate-500">
                Create a new category for GATTC courses.
            </p>
        </div>
    ...
    >
                ...
                <label class="flex cursor-pointer items-center gap-3">
                    ...
                    <span>
                        ...
                        <span class="block text-xs text-slate-500">
                            Active categories can be assigned to courses.
                        </span>
                    </span>
        ...
        <div class="flex flex-col-reverse gap-3 border-t border-slate-200 bg-slate-50 px-6 py-4 sm:flex-row sm:justify-end">
            ...
            <button
                type="submit"
                class="inline-flex items-center justify-center gap-2 rounded-xl bg-slate-900 px-5 py-2.5 text-sm font-semibold text-white hover:bg-slate-800"
            >
