...
@section('page-heading', 'Edit Announcement')
                ...
                <div class="space-y-4 p-5">
                    ...
                    <div>
                        ...
                        <textarea name="content"
                                  rows="14"
                                  required
                                  class="w-full rounded-lg border border-slate-300 px-3 py-2.5 text-sm leading-7">{{ old('content', $announcement->content) }}</textarea>
                    </div>
                ...
                <div class="space-y-4 p-5">
                    ...
                    <div>
                        ...
                        <select name="status"
                            ...
                            <option value="1" @selected(old('status', $announcement->status) == '1')>
                                Published
                            </option>
                            <option value="0" @selected(old('status', $announcement->status) == '0')>
                                Hidden
                            </option>
                        </select>
                    </div>
